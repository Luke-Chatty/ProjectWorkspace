...
$Label3.text                     = "Online Construction Project Folder"
$Label3.AutoSize                 = $true
$Label3.width                    = 25
$Label3.height                   = 10
$Label3.Anchor                   = 'top,left'
$Label3.location                 = New-Object System.Drawing.Point(93,114)
...
$WinForm.controls.AddRange(@($PWSID,$PWSIDText,$PWSNameText,$CreateButton,$PWSName,$Label2,$Label4,$Label1,$Label3,$Picturebox))
...
$ContractName = $PWSNametext.text
$ContractType = "Construction"

Copy-PnPFile -SourceUrl 'Templates/Construction Template' -TargetUrl "Construction Projects/$PWSID $ContractName" -Force


#Set Variable
$SiteURL = "https://seddonsolutions.sharepoint.com/sites/ProjectWorkspace"
$ListName = "Construction Projects"
$ParentFolderURL = "/Construction Projects" #Site Relative Path of the document Library
$UserAccount = "PWS - $PWSID"
...
$SiteURL = "https://seddonsolutions.sharepoint.com/sites/ProjectWorkspace"
$ListName = "Construction Projects"
$ParentFolderURL1 = "/Construction Projects/$PWSID $ContractName" #Site Relative Path of the document Library
$UserAccount = "PWS - $PWSID"
